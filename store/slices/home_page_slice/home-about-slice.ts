...
export const fetchHomeAboutFromAPI = createAsyncThunk('home-about', async () => {
  const getHomeAboutAPIResponse: any = await fetchHomeAboutData();
...
const homeAboutSlice = createSlice({
  ...
  extraReducers: (builder: any) => {
    builder.addCase(fetchHomeAboutFromAPI.pending, (state: any, action: any) => {
      console.log('home About data in slice pending');
      state.loading = 'pending';
      state.homeAboutData = {};
    });
    builder.addCase(fetchHomeAboutFromAPI.fulfilled, (state: any, action: any) => {
    ...
    builder.addCase(fetchHomeAboutFromAPI.rejected, (state: any, action: any) => {
...
export const home_About_selector_state = (state: RootState) => state.HomeAboutScreen;
