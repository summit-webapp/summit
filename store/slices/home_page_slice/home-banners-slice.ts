...
export const fetchHomeBannerDataFromAPI = createAsyncThunk('home-banner-slice/fetchHomeBannerDataStatus', async (TokenFromStore: any) => {
...
export const home_banner_selector_state = (state: RootState) => state.HomeBannerScreen;
