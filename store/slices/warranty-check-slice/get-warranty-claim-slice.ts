...
export const WarrantyGetClaim = createAsyncThunk(
    'fetchWarrantyGetClaim',
    async (serial_no: any) => {

        const getWarrantyGetClaim = await WarrantyGetClaimAPI(
            serial_no,
        );
...
export const warranty_get_claim_from_store = (state: RootState) =>
    state.WarrantyGetClaimSlice;
