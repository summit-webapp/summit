...
export const WarrantySerailNoDetails = createAsyncThunk('fetchWarrantySerialNoDetails', async (serial_no: any) => {
  const getSerialDetailsData = await fetchWarrantySerialNoDetails(serial_no);
...
export const warranty_serial_details_from_store = (state: RootState) => state.WarrantySerailNoDetailsSlice;
