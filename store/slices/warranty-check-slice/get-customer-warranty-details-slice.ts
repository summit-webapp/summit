...
export const GetCustomerWarrantyDetails = createAsyncThunk('fetchGetCustomerWarrantyDetails', async (customer: any) => {
  console.log('serial detailll');
  const CustomerWarrantyData = await GetCustomerWarrantyDetailsAPI(customer);
...
export const warranty_customer_details_from_store = (state: RootState) => state.GetCustomerWarrantyDetailsSlice;
