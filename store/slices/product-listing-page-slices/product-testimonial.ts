...
export const fetchProductListTestimonial: any = createAsyncThunk('product/fetchProductListTestimonial', async (category) => {
...
export const product_list_testimonial = (state: RootState) => state.ProductListTestimonial;
