...
import { AddProductToWishlist, DeleteProductfromWishlist, GetWishlistData } from '../../../services/api/wishlist-page-api/wishlist-api';
import { successmsg, failmsg, hideToast } from '../general_slices/toast_notification_slice';
import { showToast } from '../../../components/ToastNotificationNew';

export const fetchWishlistUser: any = createAsyncThunk('wishlist/fetchWishlistUser', async (request: any, { dispatch }) => {
