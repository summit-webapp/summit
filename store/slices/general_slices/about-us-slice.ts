...
export const fetchAboutUsFromSlice = createAsyncThunk(
    'aboutUs',
    async () => {
        const getAboutUsAPIResponse: any =
            await fetchAboutUsAPI()
...
const AboutUsSlice = createSlice({
    ...
    extraReducers: (builder: any) => {
        ...
        builder.addCase(
            fetchAboutUsFromSlice.fulfilled,
            (state: any, action: any) => {
        ...
        builder.addCase(
            fetchAboutUsFromSlice.rejected,
            (state: any, action: any) => {
...
export const fetch_AboutUs_selector_state = (state: RootState) =>
    state.AboutUsScreen;
