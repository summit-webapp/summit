...
import DueDateOrderReportComponent from '../../components/OrderReport/DueDateOrderReportComponent';
import { CONSTANTS } from '../../services/config/app-config';
import MetaTag from '../../services/api/general-apis/meta-tag-api';

const DueDateReminderReport = () => {
  return (
    <div>
      <DueDateOrderReportComponent />
    </div>
  );
};
...
export default DueDateReminderReport;
