...
import { cache_data_state, setCacheData } from "../store/slices/general_slices/cache-slice";
 
export const HandleAPIExpirationTime = (url: string, needToUpdate:boolean, response:any) => {
  const cache_data_selector = useSelector(cache_data_state);
