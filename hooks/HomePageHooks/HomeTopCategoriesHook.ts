...
import { fetchHomeTopCategoriesDataFromAPI, home_top_categories_selector_state } from '../../store/slices/home_page_slice/home-top-categories-slice';
import { currency_selector_state } from '../../store/slices/general_slices/multi-currency-slice';
import { get_access_token } from '../../store/slices/auth/token-login-slice';

const useHomeTopCategories = () => {
  const dispatch = useDispatch();
  const homeTopCategoriesReduxStoreData: any = useSelector(home_top_categories_selector_state);
