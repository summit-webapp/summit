...
import { fetchHomeBannerDataFromAPI, home_banner_selector_state } from '../../store/slices/home_page_slice/home-banners-slice';
...
const useHomeBanner = () => {
  ...
  useEffect(() => {
    ...
    } else if (homeBannerReduxStoreData?.loading === 'succeeded' && homeBannerReduxStoreData?.homeBannerData?.data?.length) {
