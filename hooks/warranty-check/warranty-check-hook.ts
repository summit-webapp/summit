...
import { ClearWarrantyCustomer, GetCustomerWarrantyDetails, warranty_customer_details_from_store } from '../../store/slices/warranty-check-slice/get-customer-warranty-details-slice';
...
const useWarrantyCheck = () => {
    ...
    const warrantyCustomerDetailsStoreData: any = useSelector(
        warranty_customer_details_from_store
    );
    const warrantySerialListStoreData: any = useSelector(
